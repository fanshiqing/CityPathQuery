...
public class QueryHistory extends JFrame {
	...
	private InfoPanel infoTextArea; //ÏÔÊ¾µ±Ç°Ñ¡ÖÐÂ·¾¶ÐÅÏ¢
	private JList list;
...
//		queryList = new ArrayList<models.query.Query>();
	...
	public QueryHistory() {
		...
		lblNewLabel.setFont(new Font("ï¿½ï¿½ï¿½ï¿½", Font.BOLD, 15));
		...
		label_5.setFont(new Font("ï¿½ï¿½ï¿½ï¿½", Font.BOLD, 16));
		panel_4.add(label_5);
		...
		JButton button_2 = new JButton("è¯„ä»·");
	 ...
	 */
	 private void jButtonActionPerformed(java.awt.event.ActionEvent evt) {                                         
		...
		/*
		 * ActionEvent for list "ç”¨æˆ·æŸ¥è¯¢åŽ†å²â€
		 */
	...
	//    	public static void main(String[] args) {
	    	...
	    	*/
	    	...
	    	public Comment() {
	    		...
	    		label_5.setFont(new Font("ËÎÌå", Font.BOLD, 16));
	    		panel_4.add(label_5);
	    		...
	    		btnNewButton.setFont(new Font("ËÎÌå", Font.BOLD, 14));
	    		
	    		/* Register event for â€œæ·»åŠ å›¾ç‰‡â*/
	    		...
	    		btnNewButton_1.setFont(new Font("ËÎÌå", Font.BOLD, 14));
	    		
	    		/* Register event for â€œæ·»åŠ è§†é¢‘â */
	    		...
	    		/* Register event for â€œè¯„ä»·æ‰“åˆ†â*/
	    		btnNewButton_2 = new JButton("ÆÀ¼Û");
	    		btnNewButton_2.setFont(new Font("ËÎÌå", Font.BOLD, 14));
	    		...
	    		button.setFont(new Font("ï¿½ï¿½ï¿½ï¿½", Font.BOLD, 14));
	    		
	    		/* Register eventListener for â€œç¡®è®¤â */
	    		button.addActionListener(new java.awt.event.ActionListener() {
	    			 public void actionPerformed(java.awt.event.ActionEvent evt) {
	    		...
	    		JButton button_1 = new JButton("ÍË³ö");
	    		button_1.setFont(new Font("ï¿½ï¿½ï¿½ï¿½", Font.BOLD, 14));
...
//	    		models.query.Query query = QueryHistory.this.queryList.get(QueryHistory.this.list.getSelectedIndex());
	    	...
	    	/*
	    	 * ActionEvent for "æ·»åŠ å›¾ç‰‡â€åŠâ€œæ·»åŠ è§†é¢‘â
	    	 * to be continued
	    	 */
	  	 ...
	  	 //           	Advice advice = new Advice(Client.getUser(), pathUnitID, text)
	        ...
	        /*
	    	 * ActionEvent for list: ç”¨æˆ·åˆ—è¡¨
	    	 */
	        private void jlstTaskNamesValueChanged(javax.swing.event.ListSelectionEvent evt) {                                           
	            // TODO add your handling code here:
	              if (!evt.getValueIsAdjusting()) {
